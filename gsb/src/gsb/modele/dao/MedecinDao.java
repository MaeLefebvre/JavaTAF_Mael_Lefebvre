...
public class MedecinDao {
	...
	public static int ajouterMedecins(String codeMed, String nom, String prenom, String adresse, Localite laLocalite,
			String telephone, String potentiel, String specialite) {
		int result = 0;
		String requeteInsertion = "INSERT into MEDECIN values(" + codeMed + "," + nom + "," + prenom + "," + adresse
				+ "," + laLocalite + "," + telephone + "," + potentiel + "," + specialite + ")";
		try {
